...
public class Navegador {
	...
	public static void login() {
		...
		Sistema.frame.setTitle("Funcionarios Company SA - Login");
		Navegador.atualizarTela();
	}

	public static void inicio() {
		Sistema.tela = new Inicio();
		Sistema.frame.setTitle("Funcionarios Company SA - Inicio");
		Navegador.atualizarTela();
	}
...
public static void funcionariosCadastrar() {
	...
	Sistema.frame.setTitle("Funcionarios Company SA - cadastrar");
	Navegador.atualizarTela();
}
